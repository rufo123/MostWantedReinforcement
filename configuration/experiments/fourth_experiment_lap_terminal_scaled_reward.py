"""
This module contains the `FourthExperimentLapTerminalScaledReward` class, which implements the
 ...
 In this experiment, a lap terminal reward function is used that is scaled to the range [-1, 1].
"""
...
class FourthExperimentLapTerminalScaledReward(IConfiguration):
    """
    ...
    def return_model(self) -> AShortRaceFactory:
        """
         Returns an instance of `AShortRaceFactory` that is used to generate the neural network
          model for the fourth experiment.
    ...
    def return_enabled_game_api_values(self) -> EnabledGameApiValues:
        ...
        Returns:
            EnabledGameApiValues: An enabled game api values for the forth experiment.
        """
